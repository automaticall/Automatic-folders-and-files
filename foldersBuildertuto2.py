...
'''file__ build file withut build folder'''
class file__():
    
    def __init__(self,link,new_file):
        self.new_file=new_file
        self.link=link
        self.File__=self.link+'/'+self.new_file
...
source='C:/Users/33605/Desktop/statistical learning methods'
